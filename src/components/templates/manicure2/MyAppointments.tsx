        ...
        {step === 'phone' ? (
          ...
          appointments.length === 0 ? (
            <div className={styles.apptEmpty}>
              ...
              <button onClick={() => setStep('phone')} style={{ marginTop: '20px', color: '#ffacb4', textDecoration: 'underline', background: 'transparent', border: 'none', cursor: 'pointer' }}>Nova Busca</button>
            </div>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <button onClick={() => setStep('phone')} style={{ alignSelf: 'center', color: '#ffacb4', textDecoration: 'underline', background: 'transparent', border: 'none', cursor: 'pointer', marginBottom: '10px' }}>Buscar outro número</button>
